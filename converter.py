...
DOWNLOAD_BUCKET = "accedia-jupyter-html"  #os.environ['download_bucket']
UPLOAD_BUCKET =  "accedia-jupyter-notebooks" #os.environ['upload_bucket']

def handler(event, context):

    try:
        notebook_name = "notebook.ipynb"#event['notebook_name']
